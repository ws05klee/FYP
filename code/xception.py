...
summary_path = 'model_saved_new1\\xception\\adam0.01\\'


model_filepath = summary_path + "model-Xception-{epoch:02d}-{val_accuracy:.4f}.h5"
...
model_name =  'model-Xception-38-0.8300'
...
summary_path = 'model_saved_new\\xception\\'

# result_path use this to store different condition
result_path  = ''
model_name = 'model-Xception-19-0.9350'
