...
summary_path = 'model_saved_new1\\vgg\\adam0.01\\'


model_filepath = summary_path + "model-VGG16-{epoch:02d}-{val_accuracy:.4f}.h5"
...
model_name =  'model-VGG16-07-0.7825'
...
summary_path = 'model_saved_new\\vgg\\'

# result_path use this to store different condition
result_path  = ''
model_name = 'model-VGG16-37-0.9375'
