...
# plt.figure()
# plt.plot()
# plt.plot(history_df_adam0['epochs'],history_df_adam0['accuracy'],label='Training Accuracy')
# plt.plot(history_df_adam0['epochs'],history_df_adam0['val_accuracy'],label='Validation Accuracy')
# plt.legend(loc="center right")
# plt.title("Tranning and Validation Accuracy for VGG16")
# plt.xlabel("Epoch #")
# plt.ylabel("Accuracy")
# # annot_max(history_df_adam0['epochs'],history_df_adam0['accuracy'])
# # annot_max(history_df_adam0['epochs'],history_df_adam0['val_accuracy'])
# plt.show()
