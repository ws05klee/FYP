...
# opt_sgd = Adam(learning_rate=initial_lr, decay=initial_lr / epochs)

opt_adam= tf.keras.optimizers.legacy.Adam(learning_rate=initial_lr, decay=initial_lr / epochs)
opt_sgd = tf.keras.optimizers.legacy.Adam(learning_rate=initial_lr, decay=initial_lr / epochs)
...
# summary_path = 'model_saved_new1\\mobile\\sgd0.0001\\'

summary_path = 'model_saved_new1\\mobile\\adam0.01\\'



model_filepath = summary_path + "model-MobileV2-{epoch:02d}-{val_accuracy:.4f}.h5"
...
model_name =  'model-MobileV2-36-0.9525'
...
# summary_path = 'model_saved_new\\mobile\\'
summary_path = 'mobile\\'
...
summary_path = 'model_saved_new1\\dense\\sgd0.0001\\'
# summary_path = 'mobile\\'

# result_path use this to store different condition
result_path  = ''
model_name = 'model-Dense201-38-0.8200'
