...
summary_path = 'model_saved_new1\\dense\\adam0.1\\'


model_filepath = summary_path + "model-Dense201-{epoch:02d}-{val_accuracy:.4f}.h5"
...
summary_path = 'model_saved_new1\\dense\\sgd0.01\\'
